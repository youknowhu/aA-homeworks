...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["sugar", "flour", "eggs", "72% dark chocolate"]
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { brownie.eat(120) }.to raise_error
    end
  end

  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Kimmy the Great Baker")
     expect(brownie.serve).to eq("Chef Kimmy the Great Baker has made 100 brownies!")
    end
